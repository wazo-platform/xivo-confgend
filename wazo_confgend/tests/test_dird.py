...
class TestDirdFrontEndViews(unittest.TestCase):
    ...
    @patch('wazo_confgend.dird._AssociationGenerator')
    @patch('wazo_confgend.dird._PhoneAssociationGenerator')
    @patch('wazo_confgend.dird._DisplayGenerator')
...
class TestNoContextSeparationDirdFrontendViewsGenerators(unittest.TestCase):
    ...
    @patch('wazo_confgend.dird.cti_displays_dao')
    ...
    @patch('wazo_confgend.dird.cti_context_dao')
...
class TestNoContextSeparationDirdFrontendServices(unittest.TestCase):
    ...
    @patch('wazo_confgend.dird.cti_displays_dao', Mock())
    @patch('wazo_confgend.dird.cti_reverse_dao', Mock())
